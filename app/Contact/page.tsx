            ...
            <div className='grid lg:grid-cols-2 gap-12 w-full'>
                ...
                <div className='bg-gray-500/5 p-5 rounded-xl shadow-lg'>
                    ...
                    <form className='space-y-7'>
                        ...
                        <button type='submit' className='bg-[var(--primary-color)] hover:bg-white text-white hover:text-black px-6 py-3 mt-0 rounded-lg font-semibold transition-all duration-500 cursor-pointer'>Send Message</button>
                    </form>
                </div>
