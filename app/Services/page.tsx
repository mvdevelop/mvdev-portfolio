...
const servicesData = [
    {
        ...
        id: '02', title: 'Backend', description: 'Building robust server-side applications and APIs with Node.js, Springboot, and databases like SQL and NoSQL.'
    }, {
        id: '03', title: 'Mobile', description: 'Creating intuitive and visually engaging mobile and web interfaces using React Native, with a strong emphasis on user experience.'
    }, {
...
export default function Services() {
  return (
    <>
        <section className='px-[8%] lg:px-[16%] py-5 text-white'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                {servicesData.map((service, index) => (
                    <div key={index} className='service-card group py-5 px-10 border border-gray-800 rounded-xl transition-all duration-500 cursor-pointer hover:border-[--primary-color]'>
