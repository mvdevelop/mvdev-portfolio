...
export default function HeroSection() {
    ...
    return (
        <section id="hero" className="min-h-screen flex flex-col justify-center text-white py-0 relative overflow-hidden">
            ...
            <div className="flex pt-32 lg:pt-0 flex-col lg:flex-row items-center justify-between px-[8%] lg:px-[16%] flex-1">
                ...
                >
                    ...
                    <h1 className="text-5xl text-start lg:text-6xl font-unbounded font-normal mb-2">
                        Hello I&apos;m <span className="text-[color:var(--primary-color)]">Vinicius Dilly</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-8 items-center">
                        ...
                        <div className="flex hero-social gap-2 text-3xl">
                            <Link href='https://github.com/mvdevelop' target='_blank' className="group">
                                <i className="bi bi-github cursor-pointer"></i>
                            </Link>
                            <Link href='https://linkedin.com/in/mvdevelop' target='_blank' className="group">
                                <i className="bi bi-linkedin cursor-pointer"></i>
                            </Link>
                            <Link href='https://instagram.com/mvdevelop' target='_blank' className="group">
            ...
            >
                {statsData.map((stat, index) => (
                    <div key={index} className='flex gap-2 items-center'>
                        <h1
                            ref={(el) => { if (el) countRefs.current[index] = el; }}
